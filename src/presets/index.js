...
const EVENT_RULESET_DEFENSE_BASIC = [
  ...
  {
    id: 'preset_player_online',
    name: '队友上线通知',
    event: 'player_online',
    trigger: { cooldownMs: 5_000 },
    enabled: true,
    _meta: { message: '{member}已上线｜上线位置:{member_grid}', actions: [{ type: 'team_chat' }] },
  },
  {
    id: 'preset_player_offline',
    name: '队友下线通知',
    event: 'player_offline',
    trigger: { cooldownMs: 5_000 },
    enabled: true,
    _meta: { message: '{member}已离线｜离线位置:{member_grid}', actions: [{ type: 'team_chat' }] },
  },
  {
    id: 'preset_player_dead',
    name: '队友死亡通知',
    event: 'player_dead',
    trigger: { cooldownMs: 5_000 },
    enabled: true,
    _meta: { message: '{member}已死亡｜死亡位置:{member_grid}', actions: [{ type: 'team_chat' }] },
  },
  {
    id: 'preset_player_respawn',
    name: '队友重生通知',
    event: 'player_respawn',
    trigger: { cooldownMs: 5_000 },
    enabled: true,
    _meta: { message: '{member}已重生｜当前位置:{member_grid}', actions: [{ type: 'team_chat' }] },
  },
  {
    id: 'preset_player_afk',
    name: '队友挂机通知',
    event: 'player_afk',
    trigger: { cooldownMs: 5_000, afkMinutes: 15 },
    enabled: true,
    _meta: { message: '{member}已挂机{afk_duration}｜当前位置:{member_grid}', actions: [{ type: 'team_chat' }] },
  },
  {
    id: 'preset_player_afk_recover',
    name: '队友挂机恢复通知',
    event: 'player_afk_recover',
    trigger: { cooldownMs: 5_000 },
    enabled: true,
    _meta: { message: '{member}已恢复活动｜当前位置:{member_grid}', actions: [{ type: 'team_chat' }] },
  },
  {
